export class OpenViduLayout {
    ...
    setTimeout(() => {
      ...
      const smallOnes = Array.prototype.filter.call(
        this.layoutContainer.querySelectorAll(
          "#" + id + ">." + this.opts.smallClass
        ),
        this.filterDisplayNone
      )
      const bigOnes = Array.prototype.filter
        .call(
          this.layoutContainer.querySelectorAll(
      ...
      const normalOnes = Array.prototype.filter
        .call(
          this.layoutContainer.querySelectorAll(
   ...
   * @hidden
   */
  attachElements (bigOnes, normalOnes, smallOnes) {
    const HEIGHT =
   ...
   * @hidden
   */
  arrangeBigAndSmallOnes (bigOnesAux, smallOnesAux) {
    const HEIGHT =
      this.getHeight(this.layoutContainer) -
      this.getCSSNumber(this.layoutContainer, "borderTop") -
      this.getCSSNumber(this.layoutContainer, "borderBottom")
   ...
   * @hidden
   */
  existBigAndNormalOnes (bigOnes, normalOnes, smallOnes) {
    return (
   ...
   * @hidden
   */
  onlyExistBigOnes (bigOnes, normalOnes, smallOnes) {
    return (
      bigOnes.length > 0 && normalOnes.length === 0 && smallOnes.length === 0
    )
  }
   ...
   * @hidden
   */
  existBigAndNormalAndSmallOnes (bigOnes, normalOnes, smallOnes) {
